...
<div class="flex flex-wrap my-6 mx-3">
    ...
    <div class="mx-auto w-full mt-8 p-6 bg-white rounded-lg shadow-md">
        ...
        <div class="flex justify-center">
            <div class="relative group">
                <label for="profile_picture" class="cursor-pointer block relative">
                    ...
                    <form method="POST" id="profileForm" action="<?= base_url("ubahfotoAdmin"); ?>"
        ...
        <!-- Profile Inputs -->
        <form method="POST" action="<?= base_url("ubahprofilAdmin") ?>" role="form text-left"
            enctype="multipart/form-data">
            <?= csrf_field(); ?>
            <div class=" mb-4">
                <label class="mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80" for="Sizes">Nama</label>
